...
class Avara:
    def busqueda_por_avara(problema: Problema):
        ...
        while not cola_prioridad.empty():
            ...
            if nodo.es_meta():
                camino = Avara.reconstruir_camino(nodo)
                reporte = Avara.generar_reporte(
